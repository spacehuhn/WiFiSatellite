...
#include <SH1106Wire.h>     // OLED library
#include <SSD1306Wire.h>     // OLED library

#include <configs/Config.h> // Config parent class

#include <DstikeUpdater.h>

#define DISPLAY_TYPE SH1106Wire
...
namespace simplemenu {
    class ConfigOLED: public Config {
        public:
            ConfigOLED(bool flipped = true);
            ~ConfigOLED();

            void exec_prefix();
            void exec_suffix();

            void draw(unsigned int x, unsigned int y, std::string s);
            void draw_header(unsigned int x, unsigned int y, bool selected, std::string s);
            void draw_entry(unsigned int x, unsigned int y, bool selected, std::string s);
            void draw_pixel(unsigned int x, unsigned int y, bool on);
            void draw_line(unsigned int x1, unsigned int y1, unsigned int x2, unsigned int y2);
            void draw_rect(unsigned int x, unsigned int y, unsigned int width, unsigned int height, bool filled);
            void draw_circle(unsigned int x, unsigned int y, unsigned int radius, bool filled);
